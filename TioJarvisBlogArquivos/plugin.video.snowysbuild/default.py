...
base='Snowy'
ADDON=xbmcaddon.Addon(id='plugin.video.snowysbuild')
...
def CATEGORIES():
    link = OPEN_URL('http://snowyskodi.com/wizard/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Snowys Build 3.0","Downloading ",'', 'Please Wait')
