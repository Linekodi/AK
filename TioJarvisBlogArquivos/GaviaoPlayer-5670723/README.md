...
<a href="plugin.video.Gaviao-Player.zip">plugin.video.Gaviao-Player.zip</a>
<br>
<hr>
...
<p align="left">
  <ul>
    ...
    <li>Em Addons, instalar de um ficheiro zip. Quando perguntar pela localização, selecionar "Gaviao Player", e instalar "plugin.video.Gaviao-Player.zip".</li>
    -
